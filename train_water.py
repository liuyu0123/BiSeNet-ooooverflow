...
def main(params=None):
    ...
    # --- 数据路径配置 (请根据你的实际路径修改默认值) ---
    # 假设目录结构: data_root/train/images, data_root/train/masks, data_root/val/images...
    parser.add_argument('--data_root', type=str, default='./my_water_data', help='数据集根目录')
    ...
    if not os.path.exists(train_img_dir):
        print(f"Error: Training image path not found: {train_img_dir}")
        print("Please run split_dataset.py first to generate train/val folders.")
        return
